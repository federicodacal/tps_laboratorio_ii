            ...
            try
            {
                ...
                if (this.Socio is null)
                {
                    if (ValidarCampos(nombre, apellido, dni, email))
                    {
                        ...
                        if (Biblioteca.AgregarSocio(auxSocio))
                        {
                            if (SocioDAO.Guardar(auxSocio))
                            {
                        ...
                        {
                            MessageBox.Show("No se puede cargar un socio con DNI duplicado", "Error", MessageBoxButtons.OK, MessageBoxIcon.Information);
                        }
                ...
                else
                {
                    if (ValidarCampos(nombre, apellido, dni, email))
                    {
                        ...
                        if (SocioDAO.Modificar(this.Socio))
                        {
                            DialogResult = DialogResult.OK;
                        }
